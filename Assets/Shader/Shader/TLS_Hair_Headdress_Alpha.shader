...
Shader "TLStudio/FX/Character_HairHeaddress_Alpha" {
Properties {
...
SubShader {
	Tags {"Queue"="AlphaTest+150" "IgnoreProjector"="True" "RenderType"="Geometry"}
	LOD 150
    Cull Off
...
void surf (Input IN, inout SurfaceOutput o) {
	...
	fixed4 hairColor = lerp(_ColorB,_ColorA,c.r)*c.g;
	o.Albedo = lerp(hairColor,c.rgb,c.a);
	o.Alpha = lerp (c.b,c.a,c.a);
	o.Gloss =lerp(c.g,0.8,c.a);
}
