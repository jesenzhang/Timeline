...
Shader "TLStudio/FX/Water" {
    Properties {
        ...
        _RelDistortion ("RelDistortion", Float ) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                float2 uv1 = i.uv0;
                float2 uv2 = i.uv1;
                half3 _UVOffset1 = UnpackNormal(tex2D(_Normal,TRANSFORM_TEX(uv1, _Normal)));
                half3 _UVOffset2 = UnpackNormal(tex2D(_Normal,TRANSFORM_TEX(uv2, _Normal)));
                half3 _UVOffset = (_UVOffset1+_UVOffset2)*0.5;
                float2 uv3 = i.uv0+_UVOffset.rb*_RelDistortion;
                fixed4 _WaterTexture_var = tex2D(_WaterTexture,TRANSFORM_TEX(uv3, _WaterTexture));
    ...
    FallBack "TLStudio/FX/WaterMali"
}
