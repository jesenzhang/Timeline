...
Shader "CF/Transparent/DistortR1"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			v2f vert (appdata v)
			{
				...
				o.uv[2] = TRANSFORM_TEX(v.uv, _MaskTex);
				...
				o.uv[2] = uv_orient_to(o.uv[2], _Mask_Orient);
				o.uv[2] = uv_translate(o.uv[2], _Mask_USpeed, _Mask_VSpeed);
				o.uv[2] = uv_rotate(o.uv[2], _Mask_RSpeed);
			...
			fixed4 frag (v2f i) : COLOR0
			{
				...
				fixed4 maskColor = tex2D(_MaskTex, i.uv[2]);
				ret *= mainColor;
