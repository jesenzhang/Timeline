...
Shader "CF/Transparent/DissolveDist"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : COLOR0
			{
				...
				fixed4 distColor = tex2D(_DistTex, i.uv_dist);
				i.uv_diss.x += distColor.r * _ForceX;
				i.uv_diss.y += distColor.g * _ForceY;
