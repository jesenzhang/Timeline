...
Shader "CF/Transparent/AddTex"
{
	Properties
	{
		...
		_Add_Intensity ("Add_Intensity", float) = 1
		_Detail_Intensity ("Detail_Intensity", float) = 1
	}
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : COLOR0
			{
				...
				ret.rgb *= (mainColor.rgb * addColor.rgb * addColor.a * _Detail_Intensity + addColor.rgb * addColor.a * _Add_Intensity + mainColor.rgb) * _Color.rgb;
				ret.a = mainColor.a * _Color.a * i.color.a;
				return ret;
			}
			ENDCG
		}
