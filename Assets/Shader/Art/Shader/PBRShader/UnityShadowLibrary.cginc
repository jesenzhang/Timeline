...
fixed4 UnityGetRawBakedOcclusions(float2 lightmapUV, float3 worldPos)
{
            ...
            // cy engine
                ...
                return lerp(
                    UNITY_SAMPLE_TEX2D_SAMPLER(unity_ShadowMask, unity_Lightmap, lightmapUV.xy),
                    UNITY_SAMPLE_TEX2D_SAMPLER(unity_ShadowMaskFade, unity_LightmapFade, lightmapUV.xy), 
                    cyengine_lightmap_lerp);
            #else
