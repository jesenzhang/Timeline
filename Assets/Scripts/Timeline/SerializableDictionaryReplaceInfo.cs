...
namespace TimelineTools
{
    ...
    [Serializable]
    public class SerializableDictionaryReplaceInfo : IDictionary<string, ReplaceInfo>, IDictionary
    {
        ...
        public SerializableDictionaryReplaceInfo()
        {
            Initialize(0);
        }

        protected SerializableDictionaryReplaceInfo(int initialCapacity)
        {
            Initialize(initialCapacity);
        }

        SerializableDictionaryReplaceInfo(int staticCapacity, bool forceSize)
        {
        ...
        ICollection<string> IDictionary<string, ReplaceInfo>.Keys
        {
            get
            {
                if (keys == null) keys = new KeyCollection(this);
        ...
        ICollection<ReplaceInfo> IDictionary<string, ReplaceInfo>.Values
        {
            get
            {
                if (values == null) values = new ValueCollection(this);
        ...
        public ReplaceInfo this[string key]
        {
            get
            {
                int i = FindEntry(key);
        ...
        public void Add(string key, ReplaceInfo value)
        {
            Insert(key, value, true);
        }

        void ICollection<KeyValuePair<string, ReplaceInfo>>.Add(KeyValuePair<string, ReplaceInfo> keyValuePair)
        {
            Add(keyValuePair.Key, keyValuePair.Value);
        }

        bool ICollection<KeyValuePair<string, ReplaceInfo>>.Contains(KeyValuePair<string, ReplaceInfo> keyValuePair)
        {
            int i = FindEntry(keyValuePair.Key);
            if (i >= 0 && EqualityComparer<ReplaceInfo>.Default.Equals(entriesValue[i], keyValuePair.Value))
            {
                return true;
            }
            return false;
        ...
        bool ICollection<KeyValuePair<string, ReplaceInfo>>.Remove(KeyValuePair<string, ReplaceInfo> keyValuePair)
        {
            int i = FindEntry(keyValuePair.Key);
            if (i >= 0 && EqualityComparer<ReplaceInfo>.Default.Equals(entriesValue[i], keyValuePair.Value))
            {
        ...
        public bool ContainsValue(ReplaceInfo value)
        {
            if (value == null)
            {
            ...
            {
                EqualityComparer<ReplaceInfo> c = EqualityComparer<ReplaceInfo>.Default;
                for (int i = 0; i < count; i++)
                {
        ...
        private void CopyTo(KeyValuePair<string, ReplaceInfo>[] array, int index)
        {
            if (array == null)
            {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                {
                    array[index++] = new KeyValuePair<string, ReplaceInfo>(entriesKey[i], entriesValue[i]);
                }
            }
        }
        ...
        IEnumerator<KeyValuePair<string, ReplaceInfo>> IEnumerable<KeyValuePair<string, ReplaceInfo>>.GetEnumerator()
        {
            return new Enumerator(this, Enumerator.KeyValuePair);
        }
        ...
        void Initialize(int capacity, bool forceSize)
        {
            ...
            entriesValue = new ReplaceInfo[size];

            freeList = -1;
        }

        void Insert(string key, ReplaceInfo value, bool add)
        {
            if (key == null) throw new ArgumentNullException("key");
        ...
        void Resize(int newSize, bool forceNewHashCodes)
        {
            ...
            var newEntriesValue = new ReplaceInfo[newSize];
            ...
            if (buckets != null)
            {
                ...
                for (int i = buckets[bucket]; i >= 0; last = i, i = entriesNext[i])
                {
                    if (entriesHashCode[i] == hashCode && Comparer.Equals(entriesKey[i], key))
                    {
                        ...
                        entriesValue[i] = default(ReplaceInfo);
                        freeList = i;
                        freeCount++;
                        version++;
                        return true;
        ...
        public bool TryGetValue(string key, out ReplaceInfo value)
        {
            int i = FindEntry(key);
            if (i >= 0)
            {
            ...
            value = default(ReplaceInfo);
            return false;
        }

        bool ICollection<KeyValuePair<string, ReplaceInfo>>.IsReadOnly
        {
            get { return false; }
        }

        void ICollection<KeyValuePair<string, ReplaceInfo>>.CopyTo(KeyValuePair<string, ReplaceInfo>[] array, int index)
        {
            CopyTo(array, index);
        }
        ...
        void ICollection.CopyTo(Array array, int index)
        {
            ...
            KeyValuePair<string, ReplaceInfo>[] pairs = array as KeyValuePair<string, ReplaceInfo>[];
            if (pairs != null)
            {
                CopyTo(pairs, index);
            }
            ...
            else
            {
                ...
                try
                {
                    ...
                    for (int i = 0; i < count; i++)
                    {
                        if (entriesHashCode[i] >= 0)
                        {
                            objects[index++] = new KeyValuePair<string, ReplaceInfo>(entriesKey[i], entriesValue[i]);
                        }
                    }
                }
        ...
        object IDictionary.this[object key]
        {
            ...
            set
            {
                ...
                try
                {
                    ...
                    try
                    {
                        this[tempKey] = (ReplaceInfo)value;
                    }
        ...
        {
            var newDict = new SerializableDictionaryReplaceInfo(Count, true);
        ...
        public struct Enumerator : IEnumerator<KeyValuePair<string, ReplaceInfo>>,
            IDictionaryEnumerator
        {
            private SerializableDictionaryReplaceInfo dictionary;
            private int version;
            private int index;
            private KeyValuePair<string, ReplaceInfo> current;
            private int getEnumeratorRetType;  // What should Enumerator.Current return?

            internal const int DictEntry = 1;
            internal const int KeyValuePair = 2;

            internal Enumerator(SerializableDictionaryReplaceInfo dictionary, int getEnumeratorRetType)
            {
                this.dictionary = dictionary;
                version = dictionary.version;
                index = 0;
                this.getEnumeratorRetType = getEnumeratorRetType;
                current = new KeyValuePair<string, ReplaceInfo>();
            }
            ...
            public bool MoveNext()
            {
                ...
                while ((uint)index < (uint)dictionary.count)
                {
                    ...
                    {
                        current = new KeyValuePair<string, ReplaceInfo>(dictionary.entriesKey[index], dictionary.entriesValue[index]);
                        index++;
                        return true;
                    }
                    index++;
            ...
            public KeyValuePair<string, ReplaceInfo> Current
            {
                get { return current; }
            }
            ...
            object IEnumerator.Current
            {
                get
                {
                    ...
                    {
                        return new KeyValuePair<string, ReplaceInfo>(current.Key, current.Value);
                    }
                }
            }
        ...
        public sealed class KeyCollection : ICollection<string>, ICollection
        {
            ...
            public KeyCollection(SerializableDictionaryReplaceInfo dictionary)
            {
                if (dictionary == null)
                {
            ...
            public struct Enumerator : IEnumerator<string>, System.Collections.IEnumerator
            {
                ...
                internal Enumerator(SerializableDictionaryReplaceInfo dictionary)
                {
                    this.dictionary = dictionary;
                    version = dictionary.version;
                    index = 0;
        ...
        [DebuggerDisplay("Count = {Count}")]
        public sealed class ValueCollection : ICollection<ReplaceInfo>, ICollection
        {
            private SerializableDictionaryReplaceInfo dictionary;

            public ValueCollection(SerializableDictionaryReplaceInfo dictionary)
            {
                if (dictionary == null)
                {
                    throw new ArgumentNullException("dictionary");
            ...
            public void CopyTo(ReplaceInfo[] array, int index)
            {
                if (array == null)
                {
                    throw new ArgumentNullException("array");
            ...
            bool ICollection<ReplaceInfo>.IsReadOnly
            {
                get { return true; }
            }

            void ICollection<ReplaceInfo>.Add(ReplaceInfo item)
            {
                throw new NotSupportedException(SR.NotSupported_ValueCollectionSet);
            }

            bool ICollection<ReplaceInfo>.Remove(ReplaceInfo item)
            {
                throw new NotSupportedException(SR.NotSupported_ValueCollectionSet);
            }

            void ICollection<ReplaceInfo>.Clear()
            {
                throw new NotSupportedException(SR.NotSupported_ValueCollectionSet);
            }

            bool ICollection<ReplaceInfo>.Contains(ReplaceInfo item)
            {
                return dictionary.ContainsValue(item);
            }

            IEnumerator<ReplaceInfo> IEnumerable<ReplaceInfo>.GetEnumerator()
            {
                return new Enumerator(dictionary);
            }
            ...
            void ICollection.CopyTo(Array array, int index)
            {
                ...
                ReplaceInfo[] values = array as ReplaceInfo[];
                if (values != null)
                {
                    CopyTo(values, index);
                }
            ...
            public struct Enumerator : IEnumerator<ReplaceInfo>, System.Collections.IEnumerator
            {
                private SerializableDictionaryReplaceInfo dictionary;
                private int index;
                private int version;
                private ReplaceInfo currentValue;
                ...
                internal Enumerator(SerializableDictionaryReplaceInfo dictionary)
                {
                    ...
                    version = dictionary.version;
                    index = 0;
                    currentValue = default(ReplaceInfo);
                }
