namespace VFrame.UI
{
    ...
    public abstract class UIPage
    {
        ...
        //path to load ui
        private string uiPath = "Assets.Prefabs.UI.";
        ...
        //public static Func<string,AssetBundleManager.LoadAssetCompleteHandler, AssetBundleLoader> delegateAssetBundleLoadUI = null;
        public static Func<string, AssetBundleManager.LoadAssetCompleteHandler, AssetBundleLoader> delegateAsyncLoadUI = null;
        ...
        public static UIPage GetPageInstatnce(string pageName)
        {
            if (m_allPages != null && m_allPages.ContainsKey(pageName))
            {
        ...
        public static UIPage GetPageInstatnce<T>()
        {
            Type t = typeof(T);
            string pageName = t.ToString();
